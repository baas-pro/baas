stage_data = {
    ...
    '9-1': {
        ...
        'action': [
            ...
            {'t': 'click', 'p': (675, 491), "ec": True, "desc": "2 lower left"},
            {'t': 'click', 'p': (556, 482), "wait-over": True, "desc": "1 lower right"},

            {'t': 'exchange', 'ec': True, 'desc': 'change to 2'},
            {'t': 'click', 'p': (838, 279), "ec": True, "desc": "2 upper right"},
    ...
    '9-2': {
        ...
        'action': [
            ...
            {'t': 'exchange', 'ec': True, 'desc': 'change to 2'},
            {'t': 'click', 'p': (608, 485), "ec": True, "desc": "2 left"},
    ...
    '9-3': {
        ...
        'action': [
            ...
            {'t': 'exchange', 'ec': True, 'desc': 'change to 2'},
            {'t': 'click', 'p': (682, 421), "ec": True, "desc": "2 upper right"},
            {'t': 'click', 'p': (682, 421), "desc": "choose 2"},
            {'t': 'click', 'p': (582, 432), "desc": "change 1 2"},
    ...
    '9-4': {
        ...
        'action': [
            ...
            {'t': 'exchange', 'ec': True, 'desc': 'change to 2'},
            {'t': 'click', 'p': (707, 418), "ec": True, "desc": "2 lower left"},
